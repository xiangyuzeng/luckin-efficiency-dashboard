...
# Daily refresh at 02:45 US/Eastern = 06:45 UTC. It used to be 01:00 ET =
# 05:00 UTC, which is inside the nightly batch window on
# aws-luckyus-salesorder-rw — the same window the store-ops pipeline was moved
# out of on 2026-09-01 (LCNA-DBA-SQL-2026-0901-B, B-05). 02:45 also keeps this
# clear of store-ops at 02:30, so the two do not scan t_order at once.
DAILY_TIMEZONE = os.environ.get("DAILY_TIMEZONE", "US/Eastern")
DAILY_HOUR = int(os.environ.get("DAILY_HOUR", "2"))
DAILY_MINUTE = int(os.environ.get("DAILY_MINUTE", "45"))
