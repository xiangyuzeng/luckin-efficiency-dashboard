...
// 32 half-hour slots covering ET operating hours 06:00–21:30, fixed strings,
// used both for the IntervalTable rows and the IntervalCurve x-axis. Slots
// outside this window were almost always empty in NA (stores aren't open)
// and added noise; keep the buffer wide enough that early-morning and
// late-evening receipts still surface.
